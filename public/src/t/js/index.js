...
$(function(){
    ...
    __GetIP();
    __GetInfo();
    console.log("%c🌳 Name：Nguyễn Quang Hưng");
    console.log("…………./´¯/)……….. (\\¯’\\\n…………/….//……….. …\\\\….\\\n………../….//………… ….\\\\….\\\n…../´¯/…./´¯\\\\………../¯‘\\\\…./¯’\\\\\n.././…/…./…./.|_|……_| .\\\\…\\\\…\\\\…\\\\.\\\\\n(.(….(….(…./.)..)..(..(. \\\\….)….)….).)\n.\\\\…………….\\/…/…\\\\. ..\\/……………./\n..\\\\…………….. /……..\\\\………………../\n…\\\\…………..(………. ..)……………./");
  });
// CHECK FPS
...
// MUSIC PLAY
const MusicList=[
    "/public/src/t/music/a.mp3",
    "/public/src/t/music/b.mp3",
    "/public/src/t/music/c.mp3",
];
...
function ShowToast() {
  ...
  $(document).ready(function() {
    ...
    $('#Facebook').click(function() {
        OpenUrl('https://www.facebook.com/anhlakunzdeeptry`');
    });
      // SET URL YOUTUBE
    $('#Youtube').click(function() {
        OpenUrl('https://www.youtube.com/@huylowkey22-06');
    });
      // SET URL INSTAGRAM
    $('#Instagram').click(function() {
        OpenUrl('https://www.instagram.com/anhlakunzdeeptry');
    });
  });
